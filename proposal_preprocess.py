...
# TODO: partiendo de los datos introducidos en el formulario, hay que preparar un df de 1 fila como resultado. Ese df se tiene que poder usar como test en el modelo
df = [424,3242,25352,52352]
...
last_prop = proposals.tail(1)
proposals = last_prop
#print(proposals.head())
data = proposals[[
    #"Proposal Status",
                  'Technical Area Desc.','Functional Area Desc.','Geographic Area Desc.','Project Country','Price(€)','Margin','Pre-backlog generated?','Proposal Created on','Project Start Date',
